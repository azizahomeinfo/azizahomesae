...
- [ ] Audit every public source, locale, metadata, and static file against the package price table.
- [ ] Replace the stale 28,900 starting price in all seven package meta descriptions without changing delivery claims.
- [ ] Prove retired package prices are absent, verify build health, and report changed files plus unrelated amounts.
