...
const Footer = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-12 pb-12 border-b border-primary-foreground/20">
            <div className="max-w-2xl">
              <img src={logo} alt="Aziza Home - Dubai Luxury Interior Design Furniture Packages Downtown Marina Business Bay Creek Harbour Turnkey Furnishing Solutions" className="h-28 mb-6 brightness-0 invert" />
              ...
              <div className="flex gap-3">
                <a 
                  href="https://www.instagram.com/azizahomeaes/" 
                  target="_blank" 
      ...
      <a
        href="https://wa.me/971559779635?text=Hi%20Aziza%20Home%2C%20I%27d%20like%20to%20learn%20more%20about%20your%20furnishing%20services."
        target="_blank"
        rel="noopener noreferrer"
