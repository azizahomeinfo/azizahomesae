              ...
              >
                ...
                <div className="w-full lg:w-1/2 space-y-6">
                  ...
                  <div className="bg-card border border-border rounded-lg p-6">
                    ...
                    <a href={`https://wa.me/971559779635?text=${encodeURIComponent(`Hi Aziza Home, I'd like to consult about the ${pkg.title || 'furnishing'} package (${roomTypes.find((r) => r.value === selectedRoom)?.label}).`)}`} target="_blank" rel="noopener noreferrer" className="block">
